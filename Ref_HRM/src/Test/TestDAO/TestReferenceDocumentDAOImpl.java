...
import main.DAO.ReferenceDocumentDAOImpl;
import main.DAO.ReferenceDocumentDAOInterface;
import main.Model.EmployeeRefDocuments;
import main.Service.ReferenceDocumentServiceImpl;
...
class TestReferenceDocumentDAOImpl {
	...
	public void testGetAllDocuments() {
		...
		when(entityManager.createQuery("SELECT doc FROM EmployeeRefDocuments doc", EmployeeRefDocuments.class))
				.thenReturn(query);
		...
		verify(entityManager).createQuery("SELECT doc FROM EmployeeRefDocuments doc", EmployeeRefDocuments.class);
